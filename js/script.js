...
checkinElem.onchange = function () {
    ...
    function displayDetails() {
        ...
        var packageDetailsDiv = document.getElementById("packageDetails");
        ...
        if (selectedDestination === "Rishikesh") {
            var details = `
            <div class="crow">
                        <div class="ccol-left">
                            <textarea type="text" id="Rishikesh" name="Rishikesh"
                                placeholder="TOUR PACKAGE
                                Duration : 5 Nights/6 Days
                                Destination: Rishikesh
                                Date Of Journey: 25-NOV-23
                                Price : ₹42000"
            ...
            `;
            packageDetailsDiv.innerHTML = details;
        }
        if (selectedDestination === "Goa") {
            var details = `
            <div class="crow">
                        <div class="ccol-left">
                            <textarea
        ...
        if (selectedDestination === "Ladakh") {
            var details = `
            <div class="crow">
                        <div class="ccol-left">
                            <textarea type="text" id="Ladakh" name="Ladakh"
                                placeholder="TOUR PACKAGE
                                Duration : 5 Nights/6 Days
                                Destination: Ladakh
                                Date Of Journey: 25-NOV-23
